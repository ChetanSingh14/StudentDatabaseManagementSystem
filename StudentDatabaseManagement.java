...
//  creating class for adding student and thier some details
class Student{
    public String name;
    public int rollNo;
    public int age;
    ...
    public Student(String name, int rollNo, int age, int marks){
        ...
        this.age=age;
        this.marks=marks;
// constructor function ---no need to call it //
    // kishi bhi class ka object bnta h vo function automatically call ho jata h
    // ------constructors are the methods those have same name as class and they do
...
public class StudentDatabaseManagement {
   public static void main(String [] args){
    ...
    while(true){
        ...
        sc.nextLine();
 // on base of choice switch case is enter
        switch(choice){
            case 1: System.out.print("Enter your name: ");
                    ...
                    // storing data in hashmap using put and enter keys-- then data
